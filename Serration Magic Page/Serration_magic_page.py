...
class app_window:
    def __init__(self, top=None):
        ...
        top.geometry("600x486+1100+124")
        top.minsize(120, 1)
        top.maxsize(3844, 1061)
        top.resizable(0, 0)
        top.title("Serration Magic")
        ...
        self.s_logo = tk.Label(top)
        self.s_logo.place(relx=0.8, rely=0.021, height=111, width=114)
        ...
        self.Entry_pitch.configure(cursor="fleur")
